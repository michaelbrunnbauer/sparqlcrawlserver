...
public class DefaultHttpResponseParser extends AbstractMessageParser<HttpResponse> {
    private static final int MAX_GARBAGE_LINES = 128;
    ...
    protected boolean reject(@SuppressWarnings("unused") final CharArrayBuffer line, final int count) {
        return count > MAX_GARBAGE_LINES;
    }
}
